...
__sthread_lock:
        # Put 1 into eax
        movl    $1, %eax
        # lock so this operation is atomic
        lock
        # Set scheduler lock to 1 because is always is set to that and place
        # whatever scheduler_lock was into eax
        xchg   %eax, scheduler_lock(%rip)
        # if scheduler_lock is 1 return 0, if it's 0 return 1
        xor    $1, %eax
...
__sthread_unlock:
        # To release the lock ,make scheduler_lock 0
        movl     $0, scheduler_lock(%rip)
        ret
